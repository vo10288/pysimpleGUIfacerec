...
def process_images(image_path_1, image_path_2):
    ...
    matches, image_1_modified, image_2_modified = perform_face_recognition(image_path_1, image_path_2)
    ...
    # Aggiorna le immagini sull'interfaccia grafica
...
while True:
	...
	if event == sg.WINDOW_CLOSED:
		...
		if image_path_1 and image_path_2:
            # Esegue il confronto facciale in un thread separato
			threading.Thread(target=process_images, args=(image_path_1, image_path_2)).start()
		else:
