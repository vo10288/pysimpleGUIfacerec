...
def perform_face_recognition(image_1, image_2):
    ...
    return matches, distances, image_1, image_2
    ...
    if event == sg.WINDOW_CLOSED:
        ...
        if image_1 is not None and image_2 is not None:
            try:
                ...
                matches, distances, image_1, image_2 = perform_face_recognition(image_1, image_2)
                ...
                with open(report_file, 'w') as file:
                    ...
                    file.write(f'{image_path_1},{image_path_2},{matches},{distances}')
