...
def perform_face_recognition(image_1, image_2):
	# All'inizio della funzione perform_face_recognition()
	# Ridimensiona le immagini per avere le stesse dimensioni
	image_1 = cv2.resize(image_1, (480, 360))
	image_2 = cv2.resize(image_2, (480, 360))
